...
processDataRow <- function(x, series_frequency, type) {
  ...
  return (new("TClass",type=type,frequency=series_frequency,id=id, n=n, forcast_period=forcast_period,category=category,start_year=start_year,start_frequency=start_frequency, ts_complete=ts_complete, ts_training=ts_training))
}
